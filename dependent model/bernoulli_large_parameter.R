...
bernoulli_1000_5.10_1=bernoulli_sample(sample_size = 1000,tree_size = 5,alpha=10,beta=1)
bernoulli_1000_20.10_1=bernoulli_sample(sample_size = 1000,tree_size = 20,alpha=10,beta=1)
bernoulli_1000_50.10_1=bernoulli_sample(sample_size = 1000,tree_size = 50,alpha=10,beta=1)
...
bernoulli_1000_5.1_10=bernoulli_sample(sample_size = 1000,tree_size = 5,alpha =1, beta=10)
bernoulli_1000_20.1_10=bernoulli_sample(sample_size = 1000,tree_size = 20,alpha=1, beta=10)
